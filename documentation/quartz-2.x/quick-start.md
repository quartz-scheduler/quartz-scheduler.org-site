...
First, [Download the most recent stable release](/downloads/), unpack the distribution and install it so that your application can see it.
...
Full documentation of available properties is available in the [Quartz Configuration Reference](/documentation/quartz-2.x/configuration).
