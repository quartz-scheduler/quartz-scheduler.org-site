...
<div class="secNavPanel">
          ...
          <a href="/documentation/quartz-2.5.x/tutorials/tutorial-lesson-08.html" title="Go to Lesson 8">&lsaquo;&nbsp;Lesson 8</a> |
          <a href="/documentation/quartz-2.5.x/tutorials/tutorial-lesson-10.html" title="Go to Lesson 10">Lesson 10&nbsp;&rsaquo;</a>
</div>
...
can find table-creation SQL scripts in the Quartz source repository here:
https://github.com/quartz-scheduler/quartz/tree/main/quartz/src/main/resources/org/quartz/impl/jdbcjobstore
(they are also packaged in the quartz Jar as resources). If there is not already
a script for your database type, just look at one of the existing ones, and modify it in any way necessary for your DB.
One thing to note is that in these scripts, all of the tables start with the prefix "QRTZ_" (such as the tables
